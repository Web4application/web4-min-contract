...
Minimal useful [web4-cert](https://github.com/web4application/web4-cert) contract. Can be used together with
                          [webasset]         (https://github.com/web4application/web4asset
to deploy website `web4-min` tied to your `.near` account, with static content hosted on IPFS.
